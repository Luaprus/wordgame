...
const ME_DEFAULT_TEXTURE: Texture2D = preload("res://Assets/sprites/me/me_default.png")
const ME_WALK_TEXTURE: Texture2D = preload("res://Assets/sprites/me/me_walk.png")
